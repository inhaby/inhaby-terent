  ...
  return (
    <header className="sticky top-0 z-50 bg-theme-surface text-theme-text-primary border-b border-theme-border/60 shadow-sm h-20 transition-all duration-300">
      <div className="max-w-7xl mx-auto h-full px-6 flex items-center justify-between gap-4">
        ...
        {/* Center: Search pill representing the Homepage / Global Search bar */}
            ...
            <div className="flex items-center gap-1.5 xl:gap-2">
              ...
              {showMessages && (
                <button
                  ...
                  className={`flex items-center gap-2 px-3.5 py-2.5 rounded-2xl text-[11px] font-bold uppercase tracking-wider transition-all relative cursor-pointer ${activeTab === 'MESSAGES'
              ...
              {showBookings && (
                <button
                  ...
                  className={`flex items-center gap-2 px-3.5 py-2.5 rounded-2xl text-[11px] font-bold uppercase tracking-wider transition-all relative cursor-pointer ${activeTab === 'BOOKINGS'
                    ? 'text-theme-accent bg-theme-accent-soft'
                    : 'text-theme-text-secondary hover:text-theme-text-primary hover:bg-theme-bg/60'
                    }`}
                >
              ...
              {showVisits && (
                <button
                  ...
                  className={`flex items-center gap-2 px-3.5 py-2.5 rounded-2xl text-[11px] font-bold uppercase tracking-wider transition-all relative cursor-pointer ${activeTab === 'VISITS'
                    ? 'text-theme-accent bg-theme-accent-soft'
                    : 'text-theme-text-secondary hover:text-theme-text-primary hover:bg-theme-bg/60'
                    }`}
                >
              ...
              {showWishlist && (
                <button
                  ...
                  className={`flex items-center gap-2 px-3.5 py-2.5 rounded-2xl text-[11px] font-bold uppercase tracking-wider transition-all relative cursor-pointer ${activeTab === 'WISHLIST'
                    ? 'text-theme-accent bg-theme-accent-soft'
                    : 'text-theme-text-secondary hover:text-theme-text-primary hover:bg-theme-bg/60'
                    }`}
                >
              ...
              {/* Notifications Button (Priority 2) - styled to be compact and fast */}
              {showNotifications && (
                <button
                  onClick={onOpenNotifications}
                  className={`flex items-center gap-2 px-3.5 py-2.5 rounded-2xl text-[11px] font-bold uppercase tracking-wider transition-all relative cursor-pointer ${activeTab === 'NOTIFICATIONS'
                    ? 'text-theme-accent bg-theme-accent-soft'
                    : 'text-theme-text-secondary hover:text-theme-text-primary hover:bg-theme-bg/60'
                    }`}
                >
              ...
              return (
                <>
                  <button
                    ...
                    className={`flex items-center gap-2 pr-3 pl-1.5 py-1.5 rounded-full border transition-all cursor-pointer h-10 w-40 xl:w-44 shrink-0 justify-between min-w-0 ${['PROFILE', 'VERIFICATION', 'ADDRESSES', 'REFERRALS', 'SUPPORT', 'SETTINGS', 'TERMS', 'PRIVACY', 'ABOUT'].includes(activeTab) || isProfileOpen
