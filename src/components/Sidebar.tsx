...
export const Sidebar: React.FC<SidebarProps> = ({
  ...
  return (
    ...
    >
      {/* 1. BRAND LOGO SECTION (Typographic brand start directly) */}
      ...
      <nav className="flex-1 px-3 py-6 space-y-1.5 overflow-y-auto no-scrollbar">
        {navItems.map((item) => {
          ...
          // Determine if we show compact vertical style (for Tablet view OR Collapsed Desktop view)
          ...
          return (
            ...
            >
              ...
              <div className="relative shrink-0 flex items-center justify-center">
                ...
                {/* Badge Indicator inside/above icon */}
              ...
              <div className={`flex flex-col text-left transition-all duration-200 ${
                ...
                {/* Secondary subtitle only in expanded large views */}
                {!isCompact && (
      ...
      {/* 3. SETTINGS & CONSOLE FOOTER BAR (Collapse + Theme Selector) */}
      <div className="p-3 border-t border-theme-border/40 shrink-0 space-y-3 bg-theme-surface/75 backdrop-blur-sm">
        ...
        {/* Sidebar expander/collapser for desktop >= lg (1024px) */}
